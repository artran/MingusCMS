...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('cms_image', 'height', self.gf('django.db.models.fields.IntegerField')(blank=True))

        # Changing field 'Image.width'
        db.alter_column('cms_image', 'width', self.gf('django.db.models.fields.IntegerField')(blank=True))

    def backwards(self, orm):

        # Changing field 'Image.image'
        db.alter_column('cms_image', 'image', self.gf('django.db.models.fields.files.FileField')(max_length=100))

        # Changing field 'Image.height'
        db.alter_column('cms_image', 'height', self.gf('django.db.models.fields.IntegerField')())
