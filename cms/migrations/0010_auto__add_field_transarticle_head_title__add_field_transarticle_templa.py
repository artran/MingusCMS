...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TransArticle.head_title'
        db.add_column('cms_transarticle', 'head_title', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'TransArticle.template'
        db.add_column('cms_transarticle', 'template', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='trans_articles', null=True, to=orm['cms.PageTemplate']), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'TransArticle.head_title'
        db.delete_column('cms_transarticle', 'head_title')

        # Deleting field 'TransArticle.template'
        db.delete_column('cms_transarticle', 'template_id')
    ...
    models = {
        ...
        'cms.image': {
            ...
            'alt_text': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
        ...
        'cms.media': {
            'Meta': {'ordering': "['id']", 'object_name': 'Media'},
            'caption': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'cms.section': {
            'Meta': {'ordering': "['sort']", 'object_name': 'Section'},
        ...
        'cms.transarticle': {
            ...
            'template': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'trans_articles'", 'null': 'True', 'to': "orm['cms.PageTemplate']"}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        'cms.transsection': {
