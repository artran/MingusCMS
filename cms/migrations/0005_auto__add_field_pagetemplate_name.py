...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageTemplate.name'
        db.add_column('cms_pagetemplate', 'name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True), keep_default=False)
