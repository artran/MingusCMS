...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PageTemplate.name'
        db.alter_column('cms_pagetemplate', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=60))

        # Adding unique constraint on 'PageTemplate', fields ['name']
        db.create_unique('cms_pagetemplate', ['name'])

    def backwards(self, orm):

        # Changing field 'PageTemplate.name'
        db.alter_column('cms_pagetemplate', 'name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))
